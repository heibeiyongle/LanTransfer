package com.thunder.lantransfserver.server.dto;

import androidx.annotation.Keep;


import com.thunder.lantransfserver.server.transf.SocketDealer;
...
public class Beans {
    ...
    public static class VideoData{
        ...
        public byte[] toBytes(){
            ...
            System.arraycopy(SocketDealer.toBytes(frameTimeMs),0,destBytes,14,8);
