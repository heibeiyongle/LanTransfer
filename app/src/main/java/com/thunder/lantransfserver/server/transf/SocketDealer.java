        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG, "dealClient e: "+e.getMessage());
                    e.printStackTrace();
                }finally {
                    // rm
...
//        Log.i(TAG, "onGotSingleBytes: channelId: "+channelId);
    ...
    public static void sendCmdMsg(OutputStream ous, Beans.CommandMsg msg){
        Log.d(TAG, "sendControlMsg() called with: ous = [" + ous + "], msg = [" + msg + "]");
        String tmp = GsonUtils.toJson(msg);
        Log.d(TAG, "sendControlMsg() json: "+tmp);
...
//        Log.d(TAG, " ---------> sendVideoMsg called with: ous = [" + ous + "], msg = [" + msg + "]");
        try {
